				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">MGIT-PMS<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Mahatma Gandhi Institute of Technology is one of the premier Engineering Colleges in the self-financing category in the state of Telangana. MGIT is affiliated to Jawaharlal Nehru Technological University, Hyderabad. The institute has recently received accreditation for 4 years for all 6 B Tech Programs from National Board of Accreditation, New Delhi. The institute is also accredited by NAAC with an ‘A’ grade.Mahatma Gandhi Institute of Technology (MGIT) was established by the Chaitanya Bharathi Educational Society (CBES) in a serene and tranquil atmosphere at Gandipet, Hyderabad and has grown rapidly since its inception in 1997. The lush green campus of MGIT is spread over 30 acres of pleasant landscape with a constructed area of 2,50,787 sq ft.
                        </p>
					</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>Mahatma Gandhi Institute of Technology 
							<span>Kokapet(V), Gandipet(M),</span>
                            <span>Chaitanya Bharathi(PO) Ranga Reddy Dist.</span>
						    <span>HYDERABAD – 500075, TELANGANA.</span>
						</p>
					</div>
					<div class="phone">
						<p>8466997000, 040 – 24193057</p>
					</div>
				</div>
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Mahatma Gandhi Institute of Technology</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2022 MGIT | Developed by
              <a href="https://alexanderperrin.com.au/paper/shorttrip/" target="_parent">Team Kanyarashi</a>
				</div>
