	        	...
	        	<div class="form-group">
	        		<div class="input-group">
		          	...
		          	<option value="What is your first mobile number?">What is your first mobile number?</option>	
						<option value="What is your one truth which ohers donot know?">What is your one truth which others don't know?</option>
								<option value="What is your detained years in life?">What is your favourite drink?</option>
		...
		<div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>9618274392/9666668942</p>
					<a href="mailto:placements@mgit.ac.in">placements@mgit.ac.in</a>
				</div>
