    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
          <img src="images/principal.jpg" alt="Profile Photo" class="img-responsive">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                  <li>
                  <a href="../Homepage/index.php">Home MGIT-PMS</a>
                </li>
                <li>
					   ...
					   <td><a href="" class="white-text templatemo-sort-by">Branch<span class="caret"></span></a></td>
					    <td><a href="" class="white-text templatemo-sort-by">SSC<span class="caret"></span></a></td>
						 <td><a href="" class="white-text templatemo-sort-by">PU/Dip <span class="caret"></span></a></td>
						  <td><a href="" class="white-text templatemo-sort-by">BTECH<span class="caret"></span></a></td>
...
$prev = $currentpage-1;
 ...
 ?>
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2022 MGIT-PMS |
              <a href="https://alexanderperrin.com.au/paper/shorttrip/" target="_parent">Team Kanyarashi</a></p>
          </footer>
        </div>
      </div>
    </div>
